        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <img src={heroTeam} alt="Portfolio operations team managing strategic initiatives" className="rounded-lg w-full h-auto object-cover" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <img src={officeWorkspace} alt="Data analytics workspace with portfolio dashboards" className="rounded-lg w-full h-auto object-cover" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative order-2 lg:order-1">
              <img src={teamCollaboration} alt="Team optimizing portfolio processes and workflows" className="rounded-lg w-full h-auto object-cover" />
            </div>
